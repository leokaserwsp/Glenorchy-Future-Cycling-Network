...
map.getView().fit([16388338.167881, -5291398.795066, 16407947.806513, -5280295.031297], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Glenorchy City Council  - Future Cycling Network</h2>';
        return titleElement;
    })(),
